...
The catalogue holds the semantic rules; the structural block-balance codes
(missing-block-closer, unmatched-block-closer, mismatched-end-keyword) are emitted
by the parser pass, not this rule catalogue, and are registered separately below.
"""
...
# The structural block-balance diagnostics are emitted by the parser pass, not
...
STRUCTURAL_DIAGNOSTIC_RULES: dict[str, DiagnosticRuleMetadata] = {
    ...
    # (oracle-verified: the mismatch compiles), so this is a style warning rather
    # than a compile error.
    "mismatchedEndKeyword": DiagnosticRuleMetadata(
        rule_name="mismatchedEndKeyword",
        code="mismatched-end-keyword",
        title="Mismatched procedure End keyword",
        default_severity=DiagnosticSeverity.WARNING,
        category=DiagnosticCategory.SYNTAX,
        vbe_compile_equivalent=False,
        diagnostic_kind=DiagnosticEvidenceKind.STYLE_POLICY,
        source="XLIDE",
        confidence="high",
        spec_reference=(
